...
test.each([
  ...
  "Historical $comparisonVersion / $sourceVersion stays stale under v22 without rewriting evidence",
  ({ comparisonVersion, sourceVersion }) => {
    ...
    assert.equal(request.version, "documentary-service-comparison-v22");
