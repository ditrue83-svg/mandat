...
test.each([
  ...
  "Historical $comparisonVersion / $sourceVersion stays stale under v16 without rewriting evidence",
  ({ comparisonVersion, sourceVersion }) => {
    ...
    assert.equal(request.version, "documentary-service-comparison-v16");
