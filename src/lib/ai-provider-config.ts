export type AiProvider = "infomaniak" | "mistral-eu";
...
export function aiProvider(value?: string): AiProvider {
  ...
  if (value === "mistral-eu") return value;
...
export function aiModel(
  ...
  return (
    ...
    (provider === "mistral-eu" ? MISTRAL_LARGE_3_MODEL : legacyDefaultModel)
  );
}
...
export function aiProviderConfiguration(
  ...
  return {
    provider,
    baseUrl,
    apiKeyEnv: provider === "mistral-eu" ? "MISTRAL_API_KEY" : "LLM_API_KEY",
  } as const;
}
